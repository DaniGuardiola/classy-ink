...
export function isAlignItemsValue(value?: string): value is AlignItemsValue {
...
export function isAlignSelfValue(value?: string): value is AlignSelfValue {
...
export function isFlexWrapValue(value?: string): value is FlexWrapValue {
