...
export function isFragment(fragment: string) {
...
type NumericTransformerOptions = NumericValueOptions & {
  defaultValue?: number;
  fallbackFn?: (
    property: string,
    value: string,
...
const SPATIAL_VALUES = ["x", "y", "t", "b", "l", "r"] as const;
const SPATIAL_VALUES_MAP = {
  x: "X",
  y: "Y",
  t: "Top",
  b: "Bottom",
